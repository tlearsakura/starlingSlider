...
class Main extends starling.display.Sprite {
	...
	public function Main() {
		...
		slider1 = new Slider(new Rectangle(50,50,700,70),SliderType.HORIZONTAL,10,6);
		...
		slider2 = new Slider(new Rectangle(50,100,100,450),SliderType.VERTICAL,10,6);
		...
		slider3 = new Slider(new Rectangle(150,120,600,420),SliderType.HORIZONTAL,10,6);
